...
pub fn am_end_to_end_test() -> Result<(), String> {
    ...
    let mut step2: NodeBuilder<_, _, 1, 1> = step1.attach_standard("AmModulator".to_string(), AMModulator::<2048>::new(
    ...
    let mut downsampler: NodeBuilder<_, _, 1, 1> = step9.attach_standard("downsampler".to_string(), SimpleDownsampler::<2048, 36>::new());
