...
mod tests {
    ...
    fn test_get_run_model_with_buffered_data() {
        ...
        separator.buffered_data = [DataWrapper::new_with_value(BufferArray::new_with_value([1, 2])), DataWrapper::new_with_value(BufferArray::new_with_value([1, 2]))];
    ...
    fn test_call_thread_cpu() {
        ...
        let mut separator: PipelineInterleavedSeparator<i32, 2, 4> = PipelineInterleavedSeparator::new(input, [output1, output2]);
    ...
    async fn test_run_senders_with_buffered_data() {
        ...
        separator.buffered_data = [DataWrapper::new_with_value(BufferArray::new_with_value([1, 3])), DataWrapper::new_with_value(BufferArray::new_with_value([2, 4]))];
