...
pub trait PipelineRecipe<
    I: crate::pipeline::construction_layer::pipeline_traits::Sharable,
    O: crate::pipeline::construction_layer::pipeline_traits::Sharable,
>
{
    // allow to save and standardize macro-scale components that you dont wan tto repeatedly redefine
    fn construct<
        FI: crate::pipeline::construction_layer::pipeline_traits::Sharable,
        FO: crate::pipeline::construction_layer::pipeline_traits::Sharable,
    >(
