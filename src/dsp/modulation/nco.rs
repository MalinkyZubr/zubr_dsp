...
pub struct NumericalOscillator<const BUFFER_SIZE: usize> {
    carrier_amplitude: f32,
    modulation_index: f32,
}
impl<const BUFFER_SIZE: usize> NumericalOscillator<BUFFER_SIZE> {
...
impl<const BUFFER_SIZE: usize> PipelineNodeOp<BufferArray<Complex<f32>, BUFFER_SIZE>, BufferArray<Complex<f32>, BUFFER_SIZE>, 1> for NumericalOscillator<BUFFER_SIZE> {
