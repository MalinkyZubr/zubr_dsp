...
pub struct PipelineRecipe<I: Sharable, O: Sharable, const NI: usize, const NO: usize> {
    build_function: BuildFunction<I, O, NI, NO>, // this function builds the engine. The parameters represent mappings from inputs to internal nodes. The second maps from internal nodes to outputs
